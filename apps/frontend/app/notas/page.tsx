          ...
          return (
            <li key={note.id}
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-normal text-gray-500 dark:text-gray-400">{note.title}</span>
              </div>
  ...
  return (
    <div className="flex flex-col h-screen bg-bg dark:bg-bg-dark rounded-lg shadow overflow-hidden">
      <div className="w-full px-8 pt-4">
        <h1 className="text-3xl font-bold mb-6 mt-8 ml-2 text-primary dark:text-primary">Gestión de Notas</h1>
